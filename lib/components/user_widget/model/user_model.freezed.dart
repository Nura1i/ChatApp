...
abstract class $UserModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'username', nullable: true) String userName,
      @JsonKey(name: 'image', nullable: true) String image,
      String? email,
      String? password});
}
...
class _$_UserModel implements _UserModel {
  _$_UserModel(
      ...
      @JsonKey(name: 'username', nullable: true) this.userName = 'user',
      @JsonKey(name: 'image', nullable: true) this.image = '',
      this.email,
      this.password});
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, userCreatedDate: $userCreatedDate, userName: $userName, image: $image, email: $email, password: $password)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, userCreatedDate, userName, image, email, password);
...
abstract class _UserModel implements UserModel {
  factory _UserModel(
      ...
      final DateTime? userCreatedDate,
      @JsonKey(name: 'username', nullable: true) final String userName,
      @JsonKey(name: 'image', nullable: true) final String image,
      final String? email,
